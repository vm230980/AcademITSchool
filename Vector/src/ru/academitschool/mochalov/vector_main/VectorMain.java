...
public class VectorMain {
    public static void main(String[] args) {
        Vector vector1 = new Vector(0, new double[]{});
        ...
        System.out.println("Вектор 1 равен: " + vector1);
        double factor = 5;
        vector1.getVectorScalarMultiplicationResult(factor);
        System.out.println("Умножение вектора 1 на " + factor + " равно: " + vector1);
        System.out.println("----------------------------");

        //     Разворот вектора
        System.out.println("Вектор 1 равен: " + vector1);
        vector1.getInversion();
        ...
        Vector vector5 = new Vector(new double[]{4, 5});
        ...
        System.out.println("Скалярное произведение векторов 4 и 5 равно: " + Vector.getVectorsScalarMultiplicationResult(vector4, vector5));
    }
}